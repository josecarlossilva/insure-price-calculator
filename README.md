...
2. **Explorar a API**:
   Na interface do Swagger UI, você pode explorar todos os endpoints disponíveis, visualizar suas descrições, parâmetros necessários, tipos de retorno, e testar chamadas diretamente.
